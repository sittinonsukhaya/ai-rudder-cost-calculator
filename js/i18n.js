...
const translations = {
  ...
  th: {
    ...
    'section.aiConfig': 'การดำเนินงาน AI Rudder',
    'section.aiConfigDesc': 'อธิบายการดำเนินงานที่เป็นไปได้ด้วย AI Rudder',
    ...
    'field.handleTimeDesc': 'เวลาเฉลี่ยที่เจ้าหน้าที่ใช้ในการจัดการต่อสาย',
    'field.aiHandleTime': 'เวลาจัดการ Bot (นาที)',
    'field.aiHandleTimeDesc': 'เวลาเฉลี่ยที่ Bot ใช้ในการจัดการการโต้ตอบเสียง/แชท',
    'field.voiceAiHandleTime': 'เวลาจัดการเฉลี่ยของ Voice Bot (นาที)',
    'field.voiceAiHandleTimeDesc': 'เวลาเฉลี่ยที่ Voice Bot ใช้ในการจัดการต่อสาย',
    'field.chatAiHandleTime': 'เวลาจัดการเฉลี่ยของ Chat Bot (นาที)',
    'field.chatAiHandleTimeDesc': 'เวลาเฉลี่ยที่ Chat Bot ใช้ในการจัดการต่อ chat session',
    'field.deflectionRate': 'อัตรา Bot Deflection',
    'field.deflectionRateDesc': 'เปอร์เซ็นต์ของการโต้ตอบที่ Bot จัดการได้ทั้งหมดโดยไม่ต้องมีเจ้าหน้าที่',
    'field.adminHours': 'ชั่วโมงที่ประหยัดจากระบบอัตโนมัติ',
    'field.adminHoursDesc': 'ชั่วโมงทั้งหมด/เดือนที่ระบบอัตโนมัติช่วยลด เช่น โทรอัตโนมัติ จัดการคิว งานบริหาร',
    'field.chatHandleTime': 'เวลาจัดการเฉลี่ย (นาที)',
    'field.chatHandleTimeDesc': 'เวลาเฉลี่ยที่เจ้าหน้าที่ใช้ในการจัดการต่อ chat session',
