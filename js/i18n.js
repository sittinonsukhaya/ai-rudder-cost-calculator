...
const translations = {
  en: {
    ...
    'section.aiConfig': 'AI Rudder Configuration',
    'section.aiConfigDesc': 'Configure how AI Rudder handles customer interactions',
    ...
    'field.adminHoursDesc': 'Total hours/month freed by AI — e.g. autodialing, queue handling, admin tasks',
    'field.chatHandleTime': 'Avg Handle Time (Minutes)',
    'field.chatHandleTimeDesc': 'Duration per human-handled chat session',
